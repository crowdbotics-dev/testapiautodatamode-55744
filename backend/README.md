...
## Project Structure
    ...
    ├── testapiautodatamode_55744  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamode_55744`
...
2. Clone this repo and `cd testapiautodatamode_55744`
